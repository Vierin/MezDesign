...
const projects = [
  ...
  },
  {
    ...
    description: "Nowoczesny landing page dla marki uslugowej z naciskiem na konwersje i UX.",
  ...
  return (
    <section id="portfolio" className="portfolio-section">
      <div className="container portfolio-heading">
        ...
        <p>
          Tworze projekty graficzne i strony, ktore wzmacniaja pozycje marki oraz przyspieszaja
          wzrost rozpoznawalnosci w social media.
        </p>
      </div>
